...
pub fn test_circle(id: usize) -> Enemy {
  Enemy::new(
    ...
    7.,  // Resistance
    17.,  // Agility
    |party: &mut Vec<Character>, enemies: &mut Vec<Vec<Enemy>>| {
      ...
      party[random_index(party_length)].receive_battle_action(action_effects.1, action_effects.0(acting_enemy.get_battle_state_mut()));
    }
  )
}
